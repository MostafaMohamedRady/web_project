                 ...
                 <form action="RegisterController" method="post">
                    <div class="col-md-6 register-top-grid">
                        ...
                        <div>
                            ...
                            <jsp:useBean id="name" scope="session" class="entity.Users" />
                            <jsp:getProperty name="name" property="userName"  />
      
                        </div>
                        <div>
                            <span>Email Address</span>
                            <jsp:useBean id="email" scope="session" class="entity.Users" />
                            <jsp:getProperty name="email" property="userEmail"  />
                        </div>
                        <div>
                            <span>SSN</span>
                            <jsp:useBean id="ssn" scope="session" class="entity.Users" />
                            <jsp:getProperty name="ssn" property="userSsn"  />
                        </div>
                        <div>
                            <span>Charge</span>
                            <input type="text" name="userCharge" id="userCharge" value="<jsp:useBean id="charge" scope="session" class="entity.Users" />
                            <jsp:getProperty name="charge" property="userSsn"  />">
                        </div>
                        <div>
                            <span>Address</span>
                            <input type="text" name="userAdderess" id="userAdderess"  />
                        </div>
                        <div>
                        ...
                        <div>
                            <span>Job</span>
                            <input type="text" name="userJob" id="userJob"  />
                        </div>
                        <div>
                            <span>Job</span>
